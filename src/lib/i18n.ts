...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    nav: {
      ...
      pilotCluster: "National Agriculture Market Network (Live)",
    },
    farmer: {
      greeting: "Namaste",
      ...
      onlineStatus: "Online • Real-Time APMC Connected",
    ...
    advisor: {
      ...
      subtitle: "14-day price outlook (P10, P50, P90 quantiles) and scenario analysis for your district.",
      ...
      waitDaysDesc: "Supply dip in neighboring agricultural clusters creates short-term price surge.",
      ...
      preBookButton: "Pre-Book in Regional Aggregation Pool",
      sellNow: "Sell Now (Today)",
      sellNowDesc: "Immediate spot liquidation at nearest APMC. Eliminates post-harvest spoilage.",
      ...
      explainabilitySubtitle: "The LightGBM price forecast engine evaluated the following feature drivers for your regional cluster:",
      factor1: "Arrival Volume: Regional daily arrivals dropped by 14% over the last 3 days due to seasonal picking gaps.",
      factor2: "Price Momentum (7-day lag): Modal price has climbed from ₹1,750 to ₹1,850/qtl (+5.7%).",
      factor3: "Terminal Market Spread: Central terminal mandis command a premium over local spot rates, comfortably covering freight costs.",
      factor4: "Weather Factor: Clear road conditions along highway transit guarantee uninterrupted delivery.",
      chartTitle: "Price Trajectory (14-Day Quantile Band)",
      chartSubtitle: "Historical prices and P10 (Downside) - P50 (Expected) - P90 (Upside) outlook for nearest Mandi",
  ...
  mr: {
    ...
    nav: {
      ...
      pilotCluster: "राष्ट्रीय कृषी बाजार नेटवर्क (थेट)",
    },
    farmer: {
      greeting: "नमस्ते",
      ...
      onlineStatus: "ऑनलाइन • थेट एपीएमसी जोडणी सक्रिय",
    ...
    market: {
      ...
      distanceSuffix: "तुमच्या शेतापासून अंतर",
      crops: {
        Tomato: "टोमॅटो",
        Onion: "कांदा",
        Potato: "बटाटा",
    ...
    advisor: {
      ...
      subtitle: "आपल्या जिल्ह्यासाठी १४ दिवसांचा किंमत कल (P10, P50, P90 अंदाज) आणि परिस्थिती विश्लेषण.",
      ...
      waitDaysDesc: "लगतच्या कृषी भागातील आवक कमी झाल्यामुळे अल्प मुदतीत भाव वाढण्याची दाट शक्यता.",
      ...
      preBookButton: "प्रादेशिक एकत्रीकरण पूलमध्ये प्री-बुक करा",
      sellNow: "आजच विक्री करा (Sell Now)",
      sellNowDesc: "जवळच्या बाजार समितीत त्वरित रोख विक्री. साठवणुकीतील मालाची घट टळेल.",
      ...
      explainabilitySubtitle: "लाइटजीबीएम (LightGBM) मॉडेलने आपल्या प्रादेशिक क्लस्टरसाठी खालील घटकांचे विश्लेषण केले:",
      factor1: "आवक प्रमाण: मागील ३ दिवसांत प्रादेशिक दैनिक आवक १४% ने घटली आहे.",
      factor2: "किंमत वेग (७ दिवसांचा कल): सरासरी भाव ₹१,७५० वरून ₹१,८५०/क्विंटल (+५.७%) वर पोहोचला आहे.",
      factor3: "टर्मिनल बाजार तफावत: मध्यवर्ती बाजारात स्थानिक दरापेक्षा चांगला भाव मिळत असून वाहतूक खर्च भरून निघतो.",
      factor4: "हवामान व रस्ता: महामार्गावर वाहतूक सुरळीत राहण्याचा अंदाज आहे.",
      chartTitle: "किंमत अंदाज आलेख (१४ दिवसांचा संभाव्यता पट्टा)",
      chartSubtitle: "जवळच्या बाजार समितीसाठी मागील दर आणि P10 (किमान) - P50 (अपेक्षित) - P90 (कमाल) कल",
  ...
  hi: {
    ...
    nav: {
      ...
      pilotCluster: "राष्ट्रीय कृषि बाजार नेटवर्क (लाइव)",
    },
    farmer: {
      greeting: "नमस्ते",
      ...
      onlineStatus: "ऑनलाइन • लाइव एपीएमसी कनेक्टेड",
    ...
    market: {
      ...
      distanceSuffix: "आपके खेत से दूरी",
      crops: {
        Tomato: "टमाटर",
        Onion: "प्याज",
        Potato: "आलू",
    ...
    advisor: {
      ...
      subtitle: "आपके जिले के लिए 14-दिवसीय मूल्य दृष्टिकोण (P10, P50, P90 परिदृश्य) और बाजार विश्लेषण।",
      ...
      waitDaysDesc: "निकटवर्ती कृषि क्षेत्रों में आवक कम होने से अल्पकालिक मूल्य वृद्धि की संभावना है।",
      ...
      preBookButton: "क्षेत्रीय एकत्रीकरण पूल में प्री-बुक करें",
      sellNow: "आज ही बेचें (Sell Now)",
      sellNowDesc: "निकटतम एपीएमसी में तत्काल नकद बिक्री। कटाई के बाद खराब होने का शून्य जोखिम।",
      ...
      explainabilitySubtitle: "लाइटजीबीएम (LightGBM) मॉडल ने आपके क्षेत्रीय क्लस्टर के लिए निम्नलिखित कारकों का विश्लेषण किया:",
      factor1: "आवक की मात्रा: पिछले 3 दिनों में क्षेत्रीय दैनिक आवक 14% तक घट गई है।",
      factor2: "मूल्य गति (7-दिवसीय रुझान): मॉडल भाव ₹1,750 से बढ़कर ₹1,850/क्विंटल (+5.7%) हो गया है।",
      factor3: "टर्मिनल मंडी का अंतर: केंद्रीय टर्मिनल मंडियों में स्थानीय दर से अधिक भाव मिलता है जो ढुलाई खर्च पूरा करता है।",
      factor4: "मौसम और मार्ग: मुख्य राजमार्गों पर मौसम साफ है और यातायात सुगम रहेगा।",
      chartTitle: "मूल्य दृष्टिकोण चार्ट (14-दिवसीय क्वांटाइल बैंड)",
      chartSubtitle: "निकटतम मंडी के लिए ऐतिहासिक मूल्य और P10 (न्यूनतम) - P50 (अपेक्षित) - P90 (अधिकतम) दृष्टिकोण",
